			...
			<div className="relative z-10 text-center text-white max-w-md mx-auto px-6">
				...
				<div className="mb-8 relative">
					...
					>
						<Code
							size={24}
							className="absolute -top-4 left-1/2 transform -translate-x-1/2 text-yellow-300"
						/>
					</div>
					<div
						className="absolute inset-0 animate-spin"
					...
					>
						<Rocket
							size={20}
							className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 text-pink-300"
						/>
					</div>
				</div>
