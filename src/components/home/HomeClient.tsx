...
export function HomeClient({ posts }: { posts: any[] }) {
  ...
  return (
    ...
    >
      ...
      <section className="relative min-h-[100svh] flex flex-col items-center justify-center px-4 sm:px-8 z-10 pt-24 pb-16 sm:pt-20 sm:pb-0">
        <motion.div
          onMouseDownCapture={playHoverSound}
          variants={fadeInUp}
          style={{
            width: "100%",
            height: "100dvh",
        ...
        >
          ...
          <motion.div
            variants={fadeInUp}
            className="pointer-events-none mb-4 sm:mb-8 ml-2 sm:ml-4 relative z-20"
          >
          ...
          <div className="pointer-events-none relative w-full flex justify-center sm:justify-start">
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-[15vw] sm:text-[12vw] md:text-[13vw] xl:text-[11rem] 2xl:text-[12rem] leading-[0.75] tracking-tighter uppercase relative z-20 md:z-10 w-full"
            >
              <motion.span
                style={{ x: textXReverse }}
                className="block text-gray-100 font-display font-black text-center sm:text-left"
              >
                João de
              </motion.span>
            </motion.h1>
            ...
            <motion.h1
              variants={fadeInUp}
              className="text-[15vw] sm:text-[12vw] md:text-[13vw] xl:text-[11rem] 2xl:text-[12rem] leading-[0.75] tracking-tighter uppercase absolute top-[9vw] sm:top-[10vw] xl:top-[8rem] 2xl:top-[9rem] left-0 w-full z-30 pointer-events-none"
            >
              <motion.span
                style={{ x: textX }}
                className="block text-primary-500 font-serif font-black italic mix-blend-screen text-center sm:ml-[15vw] md:ml-[25vw] sm:text-left drop-shadow-[0_0_30px_rgba(0,0,0,0.8)]"
              >
                Almeida
              </motion.span>
            </motion.h1>
          ...
          <div className="mt-[15vw] sm:mt-32 w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-end relative z-40">
            <div className="md:col-span-7 lg:col-span-6 ml-2 sm:ml-4 bg-background/50 backdrop-blur-sm sm:bg-transparent sm:backdrop-blur-none p-4 sm:p-0 rounded-2xl">
              ...
              >
                ...
                <span className="text-gray-100 font-medium font-serif italic">
                  arquiteturas escaláveis
                </span>{" "}
                e experiências{" "}
                <span className="text-primary-500 font-semibold uppercase tracking-wider font-display not-italic">
                  impecáveis
                </span>
                .
              </motion.p>
              ...
              >
                <Link
                  href="/blog"
                  className="btn-primary w-full sm:w-auto text-center group flex justify-center items-center gap-3"
                >
                  Explore o Blog
                  <ArrowRight
                    size={18}
                ...
                <Link
                  href="/sobre"
                  className="btn-secondary w-full sm:w-auto text-center group flex justify-center items-center gap-3 bg-background/80"
                >
                  Sobre Mim
                  <Target
                    size={18}
            ...
            <div className="md:col-span-5 lg:col-span-4 lg:col-start-9 hidden md:flex flex-col gap-6 text-right">
              <motion.div variants={fadeInUp} className="pt-4">
                <div className="text-primary-500 font-display font-bold text-4xl mb-1 text-shadow-md">
                  {new Date().getFullYear() - 2023}+
                </div>
                <div className="text-gray-500 uppercase tracking-widest text-xs font-bold bg-background/80 inline-block px-2 rounded">
                  Anos de Experiência
                </div>
              </motion.div>
              <motion.div
      ...
      <section className="py-20 sm:py-28 md:py-32 relative z-20 border-t border-white/5 bg-background">
        <div className="container max-w-[90rem] mx-auto px-4 sm:px-8">
          ...
          >
            <div className="max-w-3xl ml-2 sm:ml-4">
              <motion.h2
                variants={fadeInUp}
                className="text-5xl sm:text-6xl md:text-8xl lg:text-[7rem] font-black font-display text-gray-100 uppercase tracking-tighter leading-[0.9] mb-8"
              >
                Minha <br />
                <span className="text-primary-500 italic font-serif tracking-normal lowercase">
                  expertise
                </span>
              </motion.h2>
              <motion.p
              ...
              >
                Unindo visão técnica profunda, arquitetura resiliente e alto
                nível de execução visual no desenvolvimento de software.
              </motion.p>
            </div>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                variants={fadeInUp}
                className={`h-full ${skill.colSpan}`}
              >
                <div className="h-full group relative overflow-hidden bg-white/5 border border-white/10 p-8 sm:p-12 hover:bg-white/10 transition-colors duration-500 flex flex-col justify-between min-h-[300px]">
                  ...
                  <div className="relative z-10">
                    <div className="mb-8 sm:mb-12 inline-flex">
                      <skill.icon
                        size={48}
                        strokeWidth={1}
                    ...
                    <div className="mt-auto">
                      <h3 className="text-2xl sm:text-3xl font-display font-bold uppercase tracking-wide text-gray-100 mb-4 sm:mb-6 group-hover:text-primary-500 transition-colors">
                        {skill.title}
                      </h3>
      ...
      {/* Insights Section */}
      <section className="py-20 sm:py-28 md:py-32 relative z-20 bg-[#080808] border-t border-white/5">
        <div className="container max-w-[90rem] mx-auto px-4 sm:px-8">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: "-100px" }}
            variants={staggerContainer}
            className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 md:mb-20 gap-8 border-b border-white/10 pb-8 md:pb-12 ml-2 sm:ml-4"
          >
            <div className="max-w-3xl">
              <motion.h2
                variants={fadeInUp}
                className="text-5xl sm:text-6xl md:text-8xl lg:text-[7rem] font-black font-display text-gray-100 uppercase tracking-tighter leading-[0.9] mb-6"
              >
                Últimos <br />
                <span className="text-primary-500 italic font-serif tracking-normal lowercase">
                  insights
              ...
              <motion.p
                variants={fadeInUp}
                className="text-xl text-gray-400 font-light max-w-xl"
              >
                Artigos sobre arquitetura, liderança e os desafios diários da
                engenharia.
              </motion.p>
            </div>
            <motion.div variants={fadeInUp}>
              <Link
                href="/blog"
                className="inline-flex items-center gap-3 text-primary-500 hover:text-white font-display uppercase tracking-widest font-bold text-sm transition-colors group"
              >
          ...
          >
            {posts.map((post, i) => (
              ...
              >
                <Link
                  href={`/blog/${post.slug}`}
                  className="block h-full group p-8 sm:p-12 hover:bg-white/5 transition-colors duration-500 relative"
                >
