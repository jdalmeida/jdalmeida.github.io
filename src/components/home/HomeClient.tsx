  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-background" ref={containerRef}>
      ...
      <section className="relative min-h-[100vh] flex flex-col items-center justify-center px-4 sm:px-8 z-10 pt-20">
        ...
        >
          {/* Badge */}
          <motion.div variants={fadeInUp} className="mb-4 sm:mb-8 ml-2 sm:ml-4 relative z-20">
          ...
          <div className="relative w-full flex justify-center sm:justify-start">
            ...
            <motion.div 
              className="absolute inset-x-0 bottom-[-5vw] sm:bottom-[-10vw] flex justify-center items-end sm:justify-center z-10 md:z-20 pointer-events-none h-[50vh] sm:h-[80vh] md:h-[90vh]"
          ...
          <div className="mt-[15vw] sm:mt-32 w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-end relative z-40">
            <div className="md:col-span-7 lg:col-span-6 ml-2 sm:ml-4 bg-background/50 backdrop-blur-sm sm:bg-transparent sm:backdrop-blur-none p-4 sm:p-0 rounded-2xl">
              <motion.p 
                variants={fadeInUp}
                className="text-xl sm:text-2xl text-gray-400 font-sans font-light leading-relaxed mb-10 max-w-2xl text-shadow-md"
              >
