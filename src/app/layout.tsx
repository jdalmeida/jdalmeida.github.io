...
export const metadata: Metadata = {
	...
	description:
		"CTO da Allpines, especialista em desenvolvimento de software, liderança técnica e transformação digital. Compartilhando insights sobre tecnologia e inovação.",
	keywords: [
		"João de Almeida",
		"CTO",
		"Allpines",
	...
	openGraph: {
		...
		description:
			"CTO da Allpines, especialista em desenvolvimento de software, liderança técnica e transformação digital.",
	...
	return (
		<html lang="pt-BR" className="scroll-smooth">
			<body className="antialiased overflow-x-hidden dark">
				...
				<div
					id="progress-bar"
					className="fixed top-0 left-0 z-[999] h-1 bg-primary-500 transition-transform duration-300 origin-left scale-x-0"
				></div>

				{/* Scroll Progress Indicator */}
				<div className="fixed top-0 left-0 right-0 z-[999] h-1 bg-gray-800/50 transition-colors duration-300">
					<div
						id="scroll-progress"
						className="h-full bg-primary-500 transition-transform duration-150 origin-left scale-x-0"
					></div>
				</div>
