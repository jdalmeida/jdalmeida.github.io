      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-gray-100 mb-6">Entre em contato</h2>
          ...
          <div className="space-y-8">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-100">Tempo de Resposta</h3>
              </div>
              <p className="text-gray-300 mb-4">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-100">Vamos conversar sobre</h3>
              </div>
