        ...
        <div className="space-y-12">
          ...
          <section className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-700 leading-relaxed">
              Sou <strong>João de Almeida</strong>, CTO da <strong>Allpines</strong>, uma empresa de soluções digitais 
          ...
          <section className="bg-gray-50 rounded-2xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
              <Building2 className="mr-3 text-primary-600" />
              Allpines
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Nossa missão</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-3">Nossa equipe</h3>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Ruan Ferreira</span>
                    <span className="text-sm text-primary-600 font-medium">CEO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">João de Almeida</span>
                    <span className="text-sm text-primary-600 font-medium">CTO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Douglas Hariel</span>
                    <span className="text-sm text-primary-600 font-medium">GCO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600">Bruno Eliel</span>
                    <span className="text-sm text-primary-600 font-medium">CI/CD</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="card p-6 text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Desenvolvimento de Software</h3>
              ...
              <div className="card p-6 text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Automação de Processos</h3>
                <p className="text-gray-600 text-sm">
