				...
				<div className="space-y-12">
					...
					<section className="prose prose-lg max-w-none">
						<p className="text-lg text-gray-300 leading-relaxed">
							Sou <strong className="text-gray-100">João de Almeida</strong>,
							CTO da <strong className="text-primary-400">Allpines</strong>, uma
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
							<div className="card p-6 text-center group hover:scale-105 transition-all duration-300">
								...
								<p className="text-gray-300 text-sm">
									Aplicações web e mobile personalizadas com tecnologias
									modernas
								</p>
							</div>
