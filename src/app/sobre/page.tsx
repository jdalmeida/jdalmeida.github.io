    ...
    <div className="container py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-100 mb-4">Sobre mim</h1>
        ...
        <div className="space-y-12">
          ...
          <section className="prose prose-lg max-w-none">
            <p className="text-lg text-gray-300 leading-relaxed">
              Sou <strong className="text-gray-100">João de Almeida</strong>, CTO da <strong className="text-primary-400">Allpines</strong>, uma empresa de soluções digitais 
          ...
          <section className="glass-card p-8">
            <h2 className="text-2xl font-bold text-gray-100 mb-6 flex items-center">
              <Building2 className="mr-3 text-primary-400" />
              Allpines
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="font-semibold text-gray-100 mb-3">Nossa missão</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-100 mb-3">Nossa equipe</h3>
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Ruan Bueno</span>
                    <span className="text-sm text-primary-400 font-medium">CEO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">João de Almeida</span>
                    <span className="text-sm text-primary-400 font-medium">CTO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Douglas Fantoni</span>
                    <span className="text-sm text-primary-400 font-medium">GCO</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Bruno Eliel</span>
                    <span className="text-sm text-primary-400 font-medium">CI/CD</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="card p-6 text-center group hover:scale-105 transition-all duration-300">
                <div className="w-12 h-12 bg-primary-900/30 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Zap className="text-primary-400" size={24} />
                </div>
                <h3 className="font-semibold text-gray-100 mb-2">Desenvolvimento de Software</h3>
              ...
              <div className="card p-6 text-center group hover:scale-105 transition-all duration-300">
                ...
                <h3 className="font-semibold text-gray-100 mb-2">Automação de Processos</h3>
                <p className="text-gray-300 text-sm">
              ...
              <div className="card p-6 text-center group hover:scale-105 transition-all duration-300">
                ...
                <h3 className="font-semibold text-gray-100 mb-2">Business Intelligence</h3>
                <p className="text-gray-300 text-sm">
