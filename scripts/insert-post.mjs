...
**3. Ops Engineering** — Observabilidade e avaliação de qualidade do contexto. Porque contexto ruim é pior que contexto nenhum. Se o agente recebe informação errada, ele não erra "mais ou menos" — ele erra com **total confiança**.
